...
export default function ResultPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
     <header className="pt-10 pb-2 flex flex-col items-center gap-5">
  <img
    src={LogoImage}
    alt="로고"
      ...
      <main className="flex-1 px-8 pb-32">
        <section className="max-w-md mx-auto space-y-4">
          ...
          <div className="w-298px h-346px bg-[#F3F3FF] rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="relative h-50 bg-[url('/uijeongbu-placeholder.jpg')] bg-cover bg-center">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-white">
                <h2 className="text-[48px] font-bold tracking-wide ">
            ...
            <div className="px-5 py-4 space-y-2">
              <p className="mt-2 text-[17px] font-bold text-[#969696] flex items-center justify-center">
                대표 랜드마크 : 의정부 미술도서관
              </p>
              ...
              <div className="mt-3 rounded-2xl bg-[#DCDCFF] px-4 py-3">
                ...
                <p className="mt-1 text-11px text-[#1B3696] text-gray-700 leading-relaxed">
          ...
          <button
            ...
            className="w-full py-5 mt-2 rounded-xl bg-[#E7E7E7] text-[17px] font-Inter font-bold text-[#707070]"
          >
            다른 지역을 선택할래요
          </button>
